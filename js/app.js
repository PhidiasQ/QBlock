(() => {
    ...
    let formValidate = {
        ...
        validateInput(formRequiredItem) {
            ...
            if (formRequiredItem.dataset.required === "phone") {
                formRequiredItem.value = formRequiredItem.value.replace(" ", "");
    ...
    if (document.getElementById("map-container")) {
        ymaps.ready((function() {
            ...
            var Piter = new ymaps.Placemark([ 59.9593, 30.326199 ], {
                hintContent: "Посадская улица"
            });
            var delivery1 = new ymaps.Placemark([ 59.956007, 30.329037 ], {
                hintContent: "улица Куйбышева"
            });
            myMap.geoObjects.add(Piter);
            myMap.geoObjects.add(delivery1);
            Piter.events.add("click", (function() {
                setAddress("Посадская улица");
                document.getElementById("map-container").style.display = "none";
            }));
            delivery1.events.add("click", (function() {
                setAddress("улица Куйбышева");
                document.getElementById("map-container").style.display = "none";
            }));
        }));
    ...
    if (document.getElementById("count")) {
        ...
        var plusElem = document.getElementById("plus");
        var minusElem = document.getElementById("minus");
        var count = 1;
        var price = 1500;
        function updatePrice() {
            totalElem.innerHTML = count * price;
        }
